...
<div class="custom-header-mobile">
    <div class="app-main-title" style="margin-bottom: 0.8rem;">🍼 Riley's Growth Tracker</div>
...
st.sidebar.markdown("<div style='height: 12px;'></div>", unsafe_allow_html=True) # Reliable spacing
...
# Compute start and end date logic natively for title insertion
...
with tab1:
    ...
    if not today_24h_df.empty:
        ...
        # Shorten Y-Axis names purely to save valuable mobile real-estate
